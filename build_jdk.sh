...
export CFLAGS+=" -DANDROID -Wno-error=implicit-function-declaration -Wno-error=int-conversion"
...
git apply --reject --whitespace=fix ../patches/zgc_old_usage_trigger.patch || exit 1
